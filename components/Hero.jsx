          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                SEVAA <br className="hidden md:block" />
                Crowd Funding Platform
              </h2>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                Crowd Funding for your different causes! Create cause or Donate
                to a cause with help of this decentralized platform Sevaa. Help
                different people in there causes or get help by people for your
                cause! Make sure to connect your Wallet before using!
              </p>
              <a
                href=""
                aria-label=""
            ...
            <div className="w-full max-w-xl xl:px-8 wl:w-5/12">
                ...
                <form action="">
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      ...
                      required
                      type="text"
                      className="flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none force:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                      id="firstName"
                      name="firstName"
                    />
                  </div>
